        ...
        <div class="flex items-center gap-6">
          ...
          <div class="flex items-center gap-3 bg-black/40 p-1 pr-4 rounded-xl border border-white/10 backdrop-blur-sm shadow-inner">
             <button 
               ...
               class="px-4 py-1.5 bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white text-xs font-bold rounded-lg hover:brightness-110 transition-all shadow-lg shadow-violet-900/40"
             >
               充值
             </button>
              ...
              <div class="relative">
                ...
                >
                  ...
                  >
                    ...
                    <span class="text-xs text-gray-400 font-medium group-hover:text-gray-300">上传尾帧（可选）</span>
                  </div>
                  <div v-else class="relative h-28 rounded-2xl overflow-hidden group shadow-lg border border-white/10">
