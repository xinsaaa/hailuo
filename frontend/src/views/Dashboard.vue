    ...
    <nav class="relative z-20 px-8 py-4 border-b border-white/10 bg-black/20 backdrop-blur-md">
      <div class="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div class="flex items-center gap-6">
          <router-link to="/kling" class="flex items-center gap-1.5 px-3 py-1.5 text-sm text-orange-400/90 hover:text-orange-300 bg-orange-500/10 hover:bg-orange-500/15 border border-orange-500/20 hover:border-orange-500/30 rounded-lg transition-all">
          ...
          <div :class="isLowBalance ? 'bg-red-900/30 border-red-500/40 animate-pulse' : 'bg-black/40 border-white/10'" class="flex items-center gap-3 p-1 pr-4 rounded-xl border backdrop-blur-sm shadow-inner transition-all duration-300">
             <button 
               ...
               :class="isLowBalance ? 'from-red-500 to-orange-500 shadow-red-900/40 animate-none' : 'from-cyan-600 to-blue-600 shadow-cyan-900/40'"
