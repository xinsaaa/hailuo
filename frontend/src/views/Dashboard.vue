...
const isJimeng = computed(() => platform.value === 'jimeng')
    ...
    <nav class="relative z-20 px-8 py-4 border-b border-white/10 bg-black/20 backdrop-blur-md">
      <div class="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div class="flex items-center gap-6">
          ...
          <router-link to="/gptimage" class="flex items-center gap-1.5 px-3 py-1.5 text-sm text-sky-400/90 hover:text-sky-300 bg-sky-500/10 hover:bg-sky-500/15 border border-sky-500/20 hover:border-sky-500/30 rounded-lg transition-all">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
            </svg>
            GPT Image 2
          </router-link>
          <router-link to="/nanobanana" class="flex items-center gap-1.5 px-3 py-1.5 text-sm text-emerald-400/90 hover:text-emerald-300 bg-emerald-500/10 hover:bg-emerald-500/15 border border-emerald-500/20 hover:border-emerald-500/30 rounded-lg transition-all">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
            </svg>
            nanobanana pro
          ...
          <button 
            ...
            :class="isLowBalance ? 'from-red-500 to-orange-500 shadow-red-900/40' : 'from-cyan-600 to-blue-600 shadow-cyan-900/40'"
      ...
      <div class="space-y-8">
        ...
        <!-- Generator -->
          <div class="relative">
            ...
            <div class="absolute -inset-1 rounded-3xl blur-2xl opacity-40" :class="isJimeng ? 'bg-gradient-to-br from-violet-500/20 to-fuchsia-500/20' : 'bg-gradient-to-br from-cyan-500/20 to-blue-500/20'"></div>
            ...
            <div class="relative bg-white/5 backdrop-blur-3xl border border-white/10 border-t-white/20 rounded-3xl p-8 shadow-2xl">
              <div class="flex justify-between items-center mb-6">
                <div>
                  ...
                  <p v-if="isJimeng" class="text-xs text-gray-400 mt-1 ml-5">
                    字节跳动出品，高质量视频生成
                  </p>
                </div>
